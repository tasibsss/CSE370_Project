...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['search_flights'])) {
        ...
        $query = "SELECT * FROM Flight WHERE departure_city = '$departure_city'";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo "<table>";
            echo "<tr><th>Flight Number</th><th>Flight Name</th><th>Date</th><th>Departure Time</th><th>Arrival Time</th><th>Arrival City</th><th>Economy Seats Available</th><th>Economy Ticket Price</th><th>Business Seat Available</th><th>Business Ticket Price</th></tr>";
